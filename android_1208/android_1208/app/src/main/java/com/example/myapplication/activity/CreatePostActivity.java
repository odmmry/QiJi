    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
            if (result.getResultCode() == RESULT_OK && result
                ...
                try {
                    ...
                    Toast.makeText(CreatePostActivity.this, "Error", Toast.LENGTH_SHORT);
                    return;
                }
                if (fileSize > 5 * 1024 * 1024) {
                    Toast.makeText(CreatePostActivity.this, "文件不能超过 5MB", Toast.LENGTH_SHORT);
                    return;
                }
                ...
                try {
                    ...
                    Toast.makeText(CreatePostActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT);
                }
            }
        });
        ...
        findViewById(R.id.tvSubmit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (content.isEmpty()) {
                    Toast.makeText(CreatePostActivity.this, "请填写内容", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (imgs.isEmpty()) {
                    Toast.makeText(CreatePostActivity.this, "请上传图片", Toast.LENGTH_SHORT).show();
                    return;
                }
